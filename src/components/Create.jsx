...
const Create = () => {
    ...
    return (
        <div className="w-full min-h-screen py-12 px-4 flex flex-col items-center justify-center bg-slate-50">
            
            <div className="w-full max-w-md mb-4 flex justify-start">
                <button 
                    onClick={() => navigate(-1)} 
                    className="text-sm text-slate-500 hover:text-blue-600 transition-colors duration-150 flex items-center gap-1 font-medium cursor-pointer"
                >
                    &larr; Back
                </button>
            </div>
